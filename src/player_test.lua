...
testPlayerNew = {}
    testPlayerNew.p1 = player.new({ r=1, g=1, b=1 }, 3, 5, 5, "right")
    testPlayerNew.p2 = player.new({ r=1, g=0, b=0 }, 2, 10, 10, "left")

    function testPlayerNew:testMulti()
        lu.assertEquals(self.p1.color, { r=1, g=1, b=1 })
        lu.assertEquals(self.p1.bodySegmentCount, 3)
        lu.assertEquals(self.p1.direction, "right")
        ...
        lu.assertEquals(self.p2.direction, "left")
