    ...
    local game = {}
        ...
        function game:processInput(key)
            ...
            if self.gameOver then
                ...
                if self.gameStart then
                    if key then self.gameStart = false end
                else
        ...
        function game:processUpdate(dt)
            local processUpdatePlayState = function(dt)
                ...
                local updateFood = function()
                end

                local handleGameOver = function()
                end
            ...
            if not self.gameOver and not self.gameStart then
